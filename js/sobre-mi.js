const marcoSobreMi = document.getElementById('marco-descrip-sobre-mi');

const descripcionSobreMi =
`
    <p>Soy una persona proactiva que le gusta alcanzar metas, emprender</p>
    <p>y superar cada bache de la vida. Nací el 30 de marzo de 1997, en</p>
    <p>Madrid (España)</p><br><br>
    
    <p>Me encanta viajar, descubrir nuevas culturas, conocer nuevas personas y</p>
